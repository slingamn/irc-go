...
### Fixed
* Fixed cases where even with `SASLOptional` enabled, failure to complete SASL would still be considered a fatal error (#126)
* Fixed excessively permissive interpretation of ISUPPORT escapes (#126)
